 ...
 *
 * Traduction intégrale des règles du framework : l'application tourne en
 * français (`APP_LOCALE=fr`) et sans ce fichier Laravel retombe sur l'anglais
 * embarqué dans `vendor`. Un administré à qui l'on refuse une saisie doit lire
 * le motif dans sa langue.
 *
 * Les tournures restent impersonnelles — « Le champ … » plutôt que « Vous avez
 * mal saisi … » : l'écran signale ce qui manque, il ne juge pas celui qui
 * remplit.
 */
...
return [
    ...
    'prohibits' => 'Le champ :attribute interdit que :other soit renseigné.',
    ...
    |--------------------------------------------------------------------------
    |
    | Sans cette table, les messages désignent le champ par son nom de colonne
    | — « Le champ first_name est obligatoire ». Ne figurent ici que les champs
    | communs à plusieurs écrans ; les formulaires dont le vocabulaire est
    | propre (référentiels, barème, sociétés) déclarent leur propre
    | `attributes()` dans leur FormRequest, qui l'emporte sur celle-ci.
    |
    */
