...
export const ShipIcon = () => (
    ...
    >
        ...
        <path
            d="M1 20c2 0 2-1.2 4-1.2s2 1.2 4 1.2 2-1.2 4-1.2 2 1.2 4 1.2 2-1.2 4-1.2 2 1.2 4 1.2"
            stroke="#7EC8F0"
            strokeWidth="1.4"
            strokeLinecap="round"
            fill="none"
...
export const PortIcon = () => (
    ...
    >
        <path
            d="M8 1.5c-2.4 0-4.3 1.9-4.3 4.2C3.7 9 8 14.3 8 14.3s4.3-5.3 4.3-8.6C12.3 3.4 10.4 1.5 8 1.5z"
            stroke="#1D3E9C"
            strokeWidth="1.3"
        />
